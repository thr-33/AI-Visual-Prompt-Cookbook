...
<p align="center">
  <img alt="風格數量" src="https://img.shields.io/badge/styles-46-ff5a7a?style=flat-square">
  <img alt="預覽圖" src="https://img.shields.io/badge/previews-92-4cc9f0?style=flat-square">
...
先看這 6 個風格。每個風格都保持輕量：一個 JSON 加兩張預覽圖。完整 46 個風格見下面的 [All Styles](#all-styles) 畫廊。
...
<p>一種明亮的社交活動 3D 海報風格：光滑玩具感頭像、飽和藍天戶外光、誇張廣角透視、傾斜大標題、螢光手繪動線，以及圓潤的活動 UI 標籤。</p>
<p><a href="styles/sunny-3d-avatar-campaign-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/sunny-3d-avatar-campaign-style.md">複製提示詞</a> · <a href="styles/sunny-3d-avatar-campaign-style">目錄</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p>一種粗糙 Y2K 螢幕拼貼風格：廣角閃光攝影、漂浮桌面式 UI 視窗、電藍手繪輪廓、塗鴉標題字、密集噪點與私人桌面日記感。</p>
<p><a href="styles/y2k-mirror-ui-scribble-collage-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/y2k-mirror-ui-scribble-collage-style.md">複製提示詞</a> · <a href="styles/y2k-mirror-ui-scribble-collage-style">目錄</a></p>
</td>
<td width="33%" valign="top">
...
<p>一種高亮收藏玩具廣告 3D 風格：酸性青檸棚拍背景、超大毛絨吉祥物、厚重小工具道具、果凍質感配件、亮粉爆炸圖形、棋盤格與貼紙、高調商業打光。</p>
<p><a href="styles/neon-plush-gadget-pop-3d-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/neon-plush-gadget-pop-3d-style.md">複製提示詞</a> · <a href="styles/neon-plush-gadget-pop-3d-style">目錄</a></p>
</td>
<td width="33%" valign="top">
