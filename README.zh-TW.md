...
<p align="center">
  <img alt="風格數量" src="https://img.shields.io/badge/styles-44-ff5a7a?style=flat-square">
  <img alt="預覽圖" src="https://img.shields.io/badge/previews-88-4cc9f0?style=flat-square">
...
先看這 6 個風格。每個風格都保持輕量：一個 JSON 加兩張預覽圖。完整 44 個風格見下面的 [All Styles](#all-styles) 畫廊。
...
<p>一種中文透視字形峽谷海報風格：極端一點透視走廊、飽和藍色中央梯形平面、堆疊的巨大白色中文標題字，以及塞滿扭曲白灰中文輔助字的黑色側牆。</p>
<p><a href="styles/blue-chinese-perspective-type-canyon-style/style.json"><strong>打開 style.json</strong></a> · <a href="docs/copy-prompts/blue-chinese-perspective-type-canyon-style.md">複製提示詞</a> · <a href="styles/blue-chinese-perspective-type-canyon-style">目錄</a></p>
</td>
<td width="33%" valign="top">
