...
이 6개 스타일로 시작하면 라이브러리의 범위를 빠르게 이해할 수 있습니다. 모든 스타일은 JSON 하나와 미리보기 이미지 두 장으로 구성됩니다. 전체 50개는 아래 [All Styles](#all-styles) 갤러리에서 볼 수 있습니다.
...
<p>로우앵글 럭셔리 사진, 빨강-흰색 체크보드 원근 평면, 넓은 흰 여백, 큰 스크립트 타이포, 절제된 에메랄드/틸 포인트를 결합한 하이패션 에디토리얼 스타일입니다.</p>
<p><a href="styles/luxury-perspective-checkerboard-editorial/style.json"><strong>style.json 열기</strong></a> · <a href="docs/copy-prompts/luxury-perspective-checkerboard-editorial.md">복사 프롬프트</a> · <a href="styles/luxury-perspective-checkerboard-editorial">폴더</a></p>
</td>
</tr>
</table>
