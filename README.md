...
<p align="center">
  <img alt="Styles" src="https://img.shields.io/badge/styles-50-ff5a7a?style=flat-square">
  <img alt="Previews" src="https://img.shields.io/badge/previews-100-4cc9f0?style=flat-square">
...
Six visual systems to start with. Every style ships as one JSON plus two preview images. Browse the complete set of 50 in the [All Styles](#all-styles) gallery below.
...
<p>A reusable beverage launch advertising system with four color-varied templates, built from giant white 3D typography, a diagonal hero drink pack, frozen liquid motion, dense launch-ad copy, and polished commercial product lighting.</p>
<p><a href="styles/multi-color-beverage-splash-ad-system-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/multi-color-beverage-splash-ad-system-style.md">Copy Prompt</a> · <a href="styles/multi-color-beverage-splash-ad-system-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p>A dense Japanese-manga-inspired food and product zine advertisement style with black ink linework, yellow advertising blocks, cream paper fields, dramatic cropped character panels, glossy illustrated hero objects, giant warped display typography, small Chinese editorial copy, and rough print texture.</p>
<p><a href="styles/yellow-black-manga-food-zine-ad-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/yellow-black-manga-food-zine-ad-style.md">Copy Prompt</a> · <a href="styles/yellow-black-manga-food-zine-ad-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p>A tall mobile-first outdoor diary poster system with a charcoal black canvas, documentary action-photo cutouts, acid green kinetic headlines, ripped paper panels, hand-drawn arrows, sticker labels, numbered sections, and dense social-note pacing.</p>
<p><a href="styles/neon-outdoor-diary-longform-collage-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/neon-outdoor-diary-longform-collage-style.md">Copy Prompt</a> · <a href="styles/neon-outdoor-diary-longform-collage-style">Folder</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p>A glossy C4D streetwear campaign poster system built from pale studio space, oversized black block typography, acid-lime marker strokes, sticker badges, fashion-tool props, low wide-angle character staging, and clean synthetic product lighting.</p>
<p><a href="styles/acid-lime-3d-streetwear-type-poster-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/acid-lime-3d-streetwear-type-poster-style.md">Copy Prompt</a> · <a href="styles/acid-lime-3d-streetwear-type-poster-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<p>A sparse premium tech-launch poster style with black negative space, centered product silhouettes, electric-blue rim light, cropped background typography, and clean white announcement copy.</p>
<p><a href="styles/electric-blue-silhouette-product-launch-style/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/electric-blue-silhouette-product-launch-style.md">Copy Prompt</a> · <a href="styles/electric-blue-silhouette-product-launch-style">Folder</a></p>
</td>
<td width="33%" valign="top">
...
<h3>Luxury Perspective Checkerboard Editorial</h3>
<p>A high-fashion editorial style with low-angle luxury photography, red-and-white checkerboard perspective planes, generous white space, oversized script type, and restrained teal accents.</p>
<p><a href="styles/luxury-perspective-checkerboard-editorial/style.json"><strong>Open style.json</strong></a> · <a href="docs/copy-prompts/luxury-perspective-checkerboard-editorial.md">Copy Prompt</a> · <a href="styles/luxury-perspective-checkerboard-editorial">Folder</a></p>
</td>
</tr>
</table>
