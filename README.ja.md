...
<p align="center">
  <img alt="Styles" src="https://img.shields.io/badge/styles-46-ff5a7a?style=flat-square">
  <img alt="Previews" src="https://img.shields.io/badge/previews-92-4cc9f0?style=flat-square">
...
まずこの 6 つを見ると、ライブラリの幅がわかります。すべてのスタイルは 1 つの JSON と 2 枚のプレビュー画像で構成されています。46 種すべては下の [All Styles](#all-styles) ギャラリーで確認できます。
...
<p>ローアングルのラグジュアリー写真、赤白チェックの遠近面、大きな白余白、巨大なスクリプト文字、控えめなエメラルドやティールのアクセントで構成する高級編集広告スタイル。</p>
<p><a href="styles/luxury-perspective-checkerboard-editorial/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/luxury-perspective-checkerboard-editorial.md">コピー用プロンプト</a> · <a href="styles/luxury-perspective-checkerboard-editorial">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p>光沢のある玩具風3Dアバター、青空の屋外光、広角パース、大きな斜体見出し、ネオンの手描きモーション、丸いステッカーラベルで作る明るいソーシャルキャンペーン風スタイル。</p>
<p><a href="styles/sunny-3d-avatar-campaign-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/sunny-3d-avatar-campaign-style.md">コピー用プロンプト</a> · <a href="styles/sunny-3d-avatar-campaign-style">フォルダ</a></p>
</td>
</tr>
<tr>
<td width="33%" valign="top">
...
<p>広角フラッシュ写真、浮遊するデスクトップ風UI、電気ブルーのマーカー線、手書き見出し、濃いデジタルノイズで構成する粗いY2K画面コラージュ。</p>
<p><a href="styles/y2k-mirror-ui-scribble-collage-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/y2k-mirror-ui-scribble-collage-style.md">コピー用プロンプト</a> · <a href="styles/y2k-mirror-ui-scribble-collage-style">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p>酸性ライムのスタジオ背景、巨大なファジーぬいぐるみ、分厚いガジェット小物、ジェリー質感アクセサリー、ホットピンクのバースト、チェッカー、ステッカー、高キー商業ライティングで作る、明るいコレクタブル玩具広告向けの 3D スタイル。</p>
<p><a href="styles/neon-plush-gadget-pop-3d-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/neon-plush-gadget-pop-3d-style.md">コピー用プロンプト</a> · <a href="styles/neon-plush-gadget-pop-3d-style">フォルダ</a></p>
</td>
<td width="33%" valign="top">
...
<p>青とネオンライムのキネティックなコミックタイポポスター。巨大な黒い中国語ブロック文字、黄色い背面プレート、放射状アクションマーク、ざらついた印刷質感で構成します。</p>
<p><a href="styles/blue-lime-kinetic-comic-type-poster-style/style.json"><strong>style.json を開く</strong></a> · <a href="docs/copy-prompts/blue-lime-kinetic-comic-type-poster-style.md">コピー用プロンプト</a> · <a href="styles/blue-lime-kinetic-comic-type-poster-style">フォルダ</a></p>
</td>
</tr>
</table>
