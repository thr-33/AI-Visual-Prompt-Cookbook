...
<p align="center">
  <img alt="风格数量" src="https://img.shields.io/badge/styles-50-ff5a7a?style=flat-square">
  <img alt="预览图" src="https://img.shields.io/badge/previews-100-4cc9f0?style=flat-square">
...
先看这 6 个风格。每个风格都保持轻量：一个 JSON 加两张预览图。完整 50 个风格见下面的 [All Styles](#all-styles) 画廊。
...
<p>一种可复用的饮料发布广告系统：四套不同配色模板、巨大的白色 3D 字体、斜向主饮料包装、冻结液体动势、密集发布广告文案和精致商业产品光。</p>
<p><a href="styles/multi-color-beverage-splash-ad-system-style/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/multi-color-beverage-splash-ad-system-style.md">复制提示词</a> · <a href="styles/multi-color-beverage-splash-ad-system-style">目录</a></p>
</td>
<td width="33%" valign="top">
...
<p>一种高定编辑广告风格：低角度奢侈品摄影、红白棋盘格透视平面、大量白色留白、超大手写体标题和克制的祖母绿或青绿色点缀。</p>
<p><a href="styles/luxury-perspective-checkerboard-editorial/style.json"><strong>打开 style.json</strong></a> · <a href="docs/copy-prompts/luxury-perspective-checkerboard-editorial.md">复制提示词</a> · <a href="styles/luxury-perspective-checkerboard-editorial">目录</a></p>
</td>
</tr>
</table>
